...
android {
    ...
    buildTypes {
        val debug by getting {
            applicationIdSuffix = ComposeArchTestBuildType.DEBUG.applicationIdSuffix
        }
        val release by getting {
            isMinifyEnabled = true
            applicationIdSuffix = ComposeArchTestBuildType.RELEASE.applicationIdSuffix
            proguardFiles(
